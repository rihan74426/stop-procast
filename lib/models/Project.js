...
const ProjectSchema = new mongoose.Schema(
  {
    ...
    // ── Public sharing — PUBLIC BY DEFAULT ───────────────────────────
    // Every project is visible to anyone with the link.
    // Owners must explicitly set isPublic: false to hide.
    isPublic: { type: Boolean, default: true },

    // AI-assigned fields (set after publicize call or auto on creation)
    publicQuality: { type: Number, default: null },
    publicSlug: { type: String, default: null },
    category: { type: String, default: null },
    tags: [String],

    // Tracks if this was forked from a public project
...
ProjectSchema.index({ isPublic: 1, category: 1, publicQuality: -1 });
ProjectSchema.index({ isPublic: 1, tags: 1 });
