...
// ─── Indexes ──────────────────────────────────────────────────────────
// id alone — used by upsert and export route
ProjectSchema.index({ id: 1 }, { unique: true });
// userId queries (dashboard load, patch, delete)
ProjectSchema.index({ userId: 1, createdAt: -1 });
// sessionId queries (anon load, limit check, claim)
ProjectSchema.index({ sessionId: 1, isAnonymous: 1 });
// Compound for scoped lookups
